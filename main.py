...
class TwitterBot:
    def __init__(self):
        ...
        # How many tweets to respond to each time the program wakes up
        self.tweet_response_limit = 35

        # Initialize the language model w/ temperature of .5 to induce some creativity
        self.llm = ChatOpenAI(
            temperature=.5, openai_api_key=OPENAI_API_KEY, model_name='gpt-4')
    ...
    def generate_response(self, mentioned_conversation_tweet_text):
        ...
        system_template = """
        Let's imagine you are Jessie Pinkman from Breaking Bad, and you will appreaciate the people who tries to learn to code.
            ...
            - Use only emojis that matches with Jessie Pinkman personality 

            Use dialogues like "You are the one who code if the person didn't have a good day coding"
        """
